...
response = WS.sendRequest(findTestObject('UserRestServices/ListUsers'))

WS.sendRequestAndVerify(findTestObject('UserRestServices/ListUsers'))
...
WS.verifyElementsCount(response, 'data', 5, FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyAlertPresent(0, FailureHandling.CONTINUE_ON_FAILURE)
